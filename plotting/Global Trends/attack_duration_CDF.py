...
#
# ⚠️ WARNING: This script cannot be used with ArticlesDataset_LLMAnswered.csv
# because Attack Duration was excluded from the LLM extraction prompts.
# This script requires the 'Attack_duration' column which is not available.
